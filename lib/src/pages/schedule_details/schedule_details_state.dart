...
class ScheduleDetailsState {
  ...
  factory ScheduleDetailsState.initial({
    bool? isValid,
    Schedule? initial,
  }) {
  ...
  @override
  String toString() =>
      "ScheduleDetailsState{isValid: $isValid, isSuccess: $isSuccess, isLoading: $isLoading, error: $error, isFetched: $isFetched, initial: $initial, tasks: $tasks}";
